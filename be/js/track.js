...
var initialSrc = "https://bwsnm.rdtk.io/"+campaignID+"?format=json";
...
setTimeout(function(){
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                document.querySelectorAll('a').forEach(function(el) {
                    if (el.href.indexOf("bwsnm.rdtk.io/click")>-1 || el.href.indexOf("bwsnm.rdtk.io/preclick")>-1) {
                    ...
                    if (el.href.indexOf("clickid={clickid}")>-1) {
                        el.href = el.href.replace(/{clickid}/, rawData.clickid);
                    }
                });
                xhrr = new XMLHttpRequest;
                xhrr.open("GET", "https://bwsnm.rdtk.io/view?clickid="+rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://bwsnm.rdtk.io/view?clickid="+rtkClickID )
        xhrTrack.send();
        document.querySelectorAll('a').forEach(function(el) {
            if (el.href.indexOf("bwsnm.rdtk.io/click")>-1 || el.href.indexOf("bwsnm.rdtk.io/preclick")>-1) {
                if (el.href.indexOf('?')>-1) {
