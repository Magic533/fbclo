...
(function () {
  ...
  function onDOMContentLoaded() {
    ...
    var takeitessage = '<div>¡Se ha reservado tu <span class="marked">iPhone 11 PRO</span> !<br></div><br>Instrucciones para conseguir tu regalo:<br>1. Ir al sitio web de la promociónal, ingrese su dirección y pague 1-2 € por el envío. 2. Samsung Galaxy S10 le será entregado en 7-9 días.</div>';
    ...
    var logomessage = '<div class="text-center">Espera!</div><br>Antes de regresar a la página de inicio, responde 7 preguntas y tendrás la oportunidad de ganar una <span class="marked"><span class="marked">Apple iPhone 11 Pro, un Samsung S10 o un iPad Air .</span></span></div>';
